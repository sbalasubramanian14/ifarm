          ...
          <div class="social-wrapper">
            <div class="social " data-pages="social">
              ...
              <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                <div class="col-md-4" >
                    <div class="tasks-nav">
                      <a href="cost_labour.php">
                      <img src="assets/img/1.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                        <h2 class="text">Labour Wages</h2>
                ...
                <div class="col-sm-4">
                   <div class="tasks-nav">
                      <a href="cost_machinery.php">
                      <img src="assets/img/2.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Machinery Charges</h2>
                ...
                <div class="col-sm-4">
                    <div class="tasks-nav">
                       <a href="cost_misc.php">
                      <img src="assets/img/3.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Miscellaneous</h2>
                ...
                <!--div class="col-sm-4">
                   <div class="tasks-nav">
                      <a href="cost_processing.php">
                      <img src="assets/img/4.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Processing Charges</h2>
                ...
                <div class="col-sm-4">
                   <div class="tasks-nav">
                      <a href="budgetanalysis.php">
                      <img src="assets/img/5.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Budget Analysis</h2>
