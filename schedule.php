    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
            ...
            <div class="social " data-pages="social">
			  ...
			  <div class="panel">
                      <div class="panel-heading" style="text-align: center;">
                            <div class="panel-title" style="font-size: 16px">Crop Yield Analysis</div>
                      </div>
                      <div class="panel-body">
                         <div class="row">
                            <div class="col-sm-12">
                              ...
                              <hr>  
                              <p style="font-family: 'Montserrat'">Please enter the require data to analyse the yield</p>
                            </div>
		...
		<div class="content">
			...
			<form class="form-horizontal" action="a_result.php" method="post">
...
for( $i=0 ; $i<34 ; $i++ )
{
   array_push($uniqNot,$season[$i]['crop']);

}
$uniq = array_unique( $uniqNot);
//print_r($uniq);
...
for( $i=0 ; $i<3697 ; $i++ )
{
   array_push($uniqNot1,$rainfall[$i]['State']);

}
$uniq1 = array_unique( $uniqNot1,SORT_STRING);
//print_r($uniq);
...
for( $i=0 ; $i<3697 ; $i++ )
{
   array_push($uniqNot2,$rainfall[$i]['District']);

}
//$uniq2 = array_unique( $uniqNot2);
$uniq2=array_intersect_key($uniqNot2, array_unique(array_map('strtolower', $uniqNot2)));
sort($uniq2);
...
?>					</select>
        ...
        <div class="form-group">
					<label class="col-sm-3 control-label">Sowing Month</label>
					<div class="col-sm-2">
						<select name="sowing" class="form-control" required>
        ...
        <div class="form-group">
					<label class="col-sm-3 control-label">Harvesting Month</label>
					<div class="col-sm-2">
						<select name="harvesting" class="form-control" required>
        ...
        <div class="form-group">
					<label class="col-sm-3 control-label">Temperature Station (Regional Info)</label>
					<div class="col-sm-2">
...
for( $i=0 ; $i<3697 ; $i++ )
{
   array_push($uniqNot3,$temp[$i]['district']);

}
$uniq3 = array_unique( $uniqNot3,SORT_STRING);
//print_r($uniq);
...
?>					</select>
        ...
        <div class="form-group">
					...
					<div class="col-sm-6">
						<input type="submit" name="Analyse" class="btn btn-sm btn-primary" value="&nbsp;&nbsp;&nbsp;&nbsp;
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Analyse&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;">
					</div>
				</div>
			</form>
