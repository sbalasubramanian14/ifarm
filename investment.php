      ...
      <div class="page-content-wrapper ">
        ...
        <div class="content ">
          <div class="social-wrapper">
              ...
              <div class="container-fluid container-fixed-lg bg-white">
                <div class="row">
                  <div class="col-sm-5">
                    ...
                    <div class="panel panel-transparent">
                      <div class="panel-heading">
                        <div class="panel-title">Investment
                        </div>
                      </div>
                      <div class="panel-body">
                        <h3>You can invest on any land you have </h3>
                        <p>
                        This investment amount will be used for the budget analysis, labour wages, machinery charges and many.
                        </p>
                        <br>
                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="panel panel-transparent">
                      <div class="panel-body">
                        <form id="form-project" role="form" autocomplete="off" novalidate="novalidate" action="invest_action.php">
                            ...
                            <div class="row clearfix">
                              <div class="col-sm-6">
                                <div class="form-group form-group-default input-group">
                                  <label>Amount</label>
                                  <input class="form-control usd" required name="amount" aria-required="true" type="text">
                              ...
                              <div class="col-sm-6">
                                <div class="form-group form-group-default input-group">
                                  <label>Date</label>
                                  <input class="form-control" value="<?php echo date('Y-m-d'); ?>"  required="" name="date" aria-required="true" type="date">
            ...
            <!-- /container -->
            <div class="container-fluid container-fixed-lg" style="margin:20px;">
                <div class="row">
                    <div class="col-md-10">
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <div class="panel-title">
                              <h3>
                                  <span class="semi-bold" tools="" <="" span=""> Your Investments</span></h3>
                            </div>
                          ...
                          <div class="panel-body">
                            <table class="table table-striped dataTable no-footer" id="stripedTable" role="grid">
                                        <thead>
                                          <tr role="row"><th style="width:30%" class="sorting_asc" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title: activate to sort column descending">Land</th><th style="width: 25%;" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Places: activate to sort column ascending">Initial Investment </th><th style="width:20%" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Activities: activate to sort column ascending">Current Balance</th></tr>
                                        </thead>
                                      </table>
                            <div class="scroll-wrapper scrollable" style="position: relative;"><div class="scroll-wrapper scrollable scroll-content scroll-scrolly_visible" style="position: relative;"><div class="scrollable scroll-content" style="height: auto; margin-bottom: 0px; margin-right: 0px; max-height: 158px;">
                              ...
                              <div class="demo-portlet-scrollable">
                                ...
                                $result = pg_query($db,"SELECT * FROM ifarm.investment where uid ='$uid'");
                                ...
                                if (pg_num_rows($result) != 0)
                                {
                                    ...
                                    while ($row = pg_fetch_array($result)) {
                                     ...
                                     ?>     
                                        ...
                                        <?php echo $row['investment_initial'];?>
                                            </td>
                                            <td class="v-align-middle">
                                        <?php echo $row['investment_current'];?>
                                            </td>
                                          </tr>
                                <?php
                                    }
                                 ...
                                 echo '<tr role="row" class="even"><td colspan="3" class="v-align-middle" >No Investments</td></tr>';
                                }
