            ...
            <div class="social " data-pages="social">
              ...
              <div class="jumbotron" data-pages="parallax" data-social="cover">
                <div class="cover-photo">
                  <img alt="Cover photo" src="assets/img/banner.jpg" />
                </div>
                <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                  <div class="inner">
                    <div class="pull-center bottom-left m-b-50" >
                      <h5 class="text-white no-margin">Welcome to your farm</h5>
                      <h1 class="text-white no-margin"><span class="semi-bold"><?php echo $_SESSION['name']; ?></span></h1>
                    </div>
                  </div>
                </div>
              </div>
