                ...
                <div class="col-md-6">
                  <div class="panel">
                      <div class="panel-heading" style="text-align: center;">
                            <div class="panel-title" style="font-size: 16px">Seeds</div>
                      </div>
                      <div class="panel-body" >
                         <div class="row">
                            <div class="col-sm-12">
                              ...
                              <hr>  
                              <p style="font-family: 'Montserrat'">Please enter the details of the new seed added to stock</p>
                            </div>

                          </div>
                          <div class="row" ng-app='myList' ng-controller="ListsController">
                            <div class="col-sm-12" ng-init="init()">
                               <form id="form-work" action="add_seeds.php" method="get " class="form-horizontal" role="form" autocomplete="off">
                                  ...
                                  <div class="form-group">
                                    <label for="fname" class="col-sm-3 control-label ">Crop Type</label>
                                    <div class="col-sm-9">
                                    <!--  <select class="cs-select cs-skin-slide cs-transparent form-control" data-init-plugin="cs-select" id="json-one" name="crop" required>
                                      ...
                                      -->
                                      <select class="cs-select cs-skin-slide cs-transparent form-control" data-init-plugin="cs-select" id="json-one" name="typebox" required  ng-model="selectedItem" ng-options="list.crop for list in lists  | unique:'crop'" >    </select>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label for="fname" class="col-sm-3 control-label ">Seed Variety</label>
                                    <div class="col-sm-9">
                                  ...
                                  <div class="form-group">
                                    <label for="fname" class="col-sm-3 control-label">Quantity to be added</label>
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" id="area"  placeholder="kgs" name="qty" required>
                                    </div>
                                  </div>
                                  <div class="form-group">
                                    <label for="fname" class="col-sm-3 control-label ">Price per Kg</label>
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" id="price"  placeholder="Price " name="ppqty" required>   
                                    </div>
                                  </div> 
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <div class="panel-title">
                              <h3>
                                  <span class="semi-bold">Seeds </span> Stock</h3>
                            </div>
                          ...
                          <div class="panel-body">
                            <table class="table table-striped dataTable no-footer" id="stripedTable" role="grid">
                                        <thead>
                                          <tr role="row"><th style="width:60%" class="sorting_asc" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title: activate to sort column descending">Seed</th><th style="width: 25%;" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Places: activate to sort column ascending">Crop </th><th style="width:10%" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Activities: activate to sort column ascending">Stock</th></tr>
                                        </thead>
                                      </table>
                            <div class="scroll-wrapper scrollable" style="position: relative;"><div class="scrollable scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: -17px; margin-right: -17px; max-height: 185px;">
                              ...
                              <div class="demo-portlet-scrollable">
                                ...
                                $result = pg_query($db,"SELECT * FROM ifarm.seed where uid ='$uid'");
                                ...
                                <?php
                                 ...
                                 echo '<tr role="row" class="even"><td colspan="3" class="v-align-middle" >No seeds in Stock</td></tr>';
                                }
