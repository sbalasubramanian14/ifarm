                ...
                <div class="col-md-6">
                  <div class="panel">
                      <div class="panel-heading" style="text-align: center;">
                            <div class="panel-title" style="font-size: 16px">chemicals</div>
                      </div>
                      <div class="panel-body" >
                         <div class="row">
                            <div class="col-sm-12">
                              ...
                              <hr>  
                              <p style="font-family: 'Montserrat'">Please enter the details of the new chemical added to stock</p>
                            </div>

                          </div>
                          <div class="row" ng-app='myList' ng-controller="ListsController">
                            <div class="col-sm-12" ng-init="init()">
                               <form id="form-work" action="add_chemicals.php" method="get " class="form-horizontal" role="form" autocomplete="off">
                                   <input type="hidden" name="name" value="{{selectedItem.crop}}" required>
                                  <input type="hidden" name="type" value="{{selectedVar.variety}}" required>
                                  ...
                                  <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                      <input type="text" class="form-control" id="area"  placeholder="qty" name="qty" required>
                                    </div>
                                  </div>
                                  <div class="form-group">
                        ...
                        <div class="panel panel-default">
                          <div class="panel-heading">
                            <div class="panel-title">
                              <h3>
                                  <span class="semi-bold">chemicals </span> Stock</h3>
                            </div>
                          ...
                          <div class="panel-body">
                            <table class="table table-striped dataTable no-footer" id="stripedTable" role="grid">
                                        <thead>
                                          <tr role="row"><th style="width:60%" class="sorting_asc" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title: activate to sort column descending">chemical</th><th style="width: 25%;" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Places: activate to sort column ascending">Type </th><th style="width:10%" class="sorting" tabindex="0" aria-controls="stripedTable" rowspan="1" colspan="1" aria-label="Activities: activate to sort column ascending">Stock</th></tr>
                                        </thead>
                                      </table>
                            <div class="scroll-wrapper scrollable" style="position: relative;"><div class="scrollable scroll-content scroll-scrolly_visible" style="height: auto; margin-bottom: -17px; margin-right: -17px; max-height: 185px;">
                              ...
                              <div class="demo-portlet-scrollable">
                                ...
                                <?php
                                 ...
                                 echo '<tr role="row" class="even"><td colspan="3" class="v-align-middle" >No chemicals in Stock</td></tr>';
                                }
