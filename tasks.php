          ...
          <div class="social-wrapper">
            <div class="social " data-pages="social">
              ...
              <div class="container-fluid container-fixed-lg sm-p-l-20 sm-p-r-20">
                <div class="col-md-4" >
                    <div class="tasks-nav">
                      <a href="newcultivation.php">
                      <img src="assets/img/newcult.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                        <h2 class="text">New Cultivation</h2>
                ...
                <div class="col-sm-4">
                   <div class="tasks-nav">
                      <a href="currentcultivation.php">
                      <img src="assets/img/current.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Current Progress</h2>
                ...
                <div class="col-sm-4">
                   ...
                   <a href="investment.php">
                      <img src="assets/img/i.jpg" alt="Avatar" class="image" style="width:100%">
                      <div class="middle">
                          <h2 class="text">Investment</h2>
