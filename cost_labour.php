  ...
  ?>
    ...
    <div class="page-container ">
      ...
      <div class="page-content-wrapper ">
        <!-- START PAGE CONTENT -->
               <form role="form" id="worker" method="get" action="cost_labour_action.php">
        <div class="content ">
              ...
              <div class="modal-content-wrapper">
                <div class="modal-content">
                  <div class="modal-header clearfix text-left">
                    ...
                    <h5>Salary <span class="semi-bold">Information</span></h5>
                    <p class="p-b-10">Please provide the required info..</p>
                  </div>
                  <div class="modal-body">
                      ...
                      <div class="form-group-attached">
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group form-group-default">
                              <label>Labour Wage</label>
                              <input class="form-control" type="text" name="labourwage" required>
                            </div>
                          </div>
                        </div>
                        ...
                        <div class="row">
                          <div class="col-sm-12">
                            <div class="form-group form-group-default">
                              <label>Operator Wage</label>
                              <input class="form-control" type="text" name="operatorwage" required>
                            </div>
                          </div>
                        </div>
                        </div>
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-4 m-t-10 sm-m-t-10">
                        <button type="button" onclick="submitform()" class="btn btn-primary btn-block m-t-5" >Pay Now</button>
                      </div>
                    </div>
                  </div>
                </div>
          ...
          <div class="social-wrapper">
            ...
            <div class="panel panel-transparent">
             <button class="btn btn-green btn-lg pull-right bottom-right" data-toggle="modal" data-target="#salary" id="btnToggleSlideUpSize">Generate</button>
              <div class="panel-heading">
                <div class="panel-title">Worker Wages
                </div>
                <div class="pull-right">
                  <div class="col-xs-12">
              ...
              <div class="panel-body">
                ...
                <table class="table table-hover demo-table-search dataTable no-footer" id="tableWithSearch" role="grid" aria-describedby="tableWithSearch_info">
                  <thead>
                    <tr role="row"><th class="sorting_asc" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" aria-sort="ascending" aria-label="Title: activate to sort column descending">Attendance</th><th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" style="width: 207px;" aria-label="Places: activate to sort column ascending">Worker</th><th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" style="width: 230px;" aria-label="Activities: activate to sort column ascending">Category</th><th class="sorting" tabindex="0" aria-controls="tableWithSearch" rowspan="1" colspan="1" style="width: 174px;" aria-label="Last Update: activate to sort column ascending">Land</th>
                  ...
                  <tr role="row" class="odd">
                      <td style="width: 20px;">
                       ...
                       <input type="hidden" name="stdId[]" value="<?php echo $row['empid']; ?>"  />
                      <td class="v-align-middle semi-bold sorting_1">
                        <p><?php echo $row['name']; ?></p>
                      </td>
                      <td class="v-align-middle">
                      <a  class="btn btn-tag"><?php echo $row['category']; ?></a>
