            ...
            <div class="social " data-pages="social">
			  ...
			  <div class="panel">
                      <div class="panel-heading" style="text-align: center;">
                            <div class="panel-title" style="font-size: 16px">Add Employee</div>
                      </div>
                      <div class="panel-body">
                         <div class="row">
                            <div class="col-sm-12">
                              ...
                              <hr>  
                              <p style="font-family: 'Montserrat'">Please enter employee details</p>
                            </div>
		...
		<div class="content">
			...
			if(isset($_POST['add'])){
				...
				if(pg_num_rows($cek) == 0){
						...
						$insert = pg_query($db, "INSERT INTO ifarm.workers
															VALUES ('$nik','$nama', '$alamat', $no_telepon, '$jabatan', '$uid')");
						if($insert){
							echo '<div class="alert alert-success alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Data Added!</div>';
						}else{
							echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Oops! Invalid data!</div>';
						}
				}else{
					echo '<div class="alert alert-danger alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>Emp Id already exists..!</div>';
				}
			}
			?>
			...
			<form class="form-horizontal" action="" method="post">
				<div class="form-group">
					...
					<div class="col-sm-2">
						<input type="text" name="nik" class="form-control" placeholder="EMP ID" required>
					</div>
				</div>
				<div class="form-group">
				...
				<div class="form-group">
					...
					<div class="col-sm-3">
						<input type="text" name="no_telepon" class="form-control" placeholder="Mobile No" required>
					</div>
				</div>
				<div class="form-group">
