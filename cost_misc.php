              ...
              <div class="container-fluid container-fixed-lg bg-white">
                <div class="row">
                  <div class="col-sm-5">
                    ...
                    <div class="panel panel-transparent">
                      <div class="panel-heading">
                        <div class="panel-title">Miscellaneous Charges
                        </div>
                      </div>
                      <div class="panel-body">
                        <h3>Add your miscellaneous charges to your account </h3>
                        <p>Despite the daily categorical expenses, you may spend some money on other things that does not come under costing, Please specify the expense description along with the amount
                        and it shall be added to your cultivation cost</p>
                        <br>
                  ...
                  <div class="col-sm-7">
                    ...
                    <div class="panel panel-transparent">
                      <div class="panel-body">
                        <form id="form-project" role="form" autocomplete="off" action="cost_misc_action.php" novalidate="novalidate">
                          <p>Basic Information</p>
                          <div class="form-group-attached">
                            <div class="form-group form-group-default required" aria-required="true">
                              <label>Expense </label>
                              <input class="form-control" name="exp" required="" aria-required="true" type="text">
                            </div>
                            <div class="row clearfix">
                              <div class="col-sm-6">
                                <div class="form-group form-group-default input-group">
                                  <label>Amount</label>
                                  <input class="form-control usd" required aria-required="true" type="text" name="amount">
                            ...
                            <div class="row clearfix">
                              <div class="col-sm-6">
                                <div class="form-group form-group-default input-group">
                                  <label>Date</label>
                                  <input class="form-control usd" name="date" required aria-required="true" type="date" value="<?php echo date('Y-m-d'); ?>">
                                  <span class="input-group-addon">
                                                           Y-M-D
                                  </span>
                                </div>
